...
- **Done / in flight:** brownfield `--baseline` / `--max-new` ratchet (`docs/ADOPTION.md`)  
- **Next phase:** publish `0.1.0` → limited invite — see `docs/superpowers/plans/2026-08-06-phase-next-ratchet-publish.md`  
