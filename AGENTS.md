...
- **Done:** brownfield `--baseline` / `--max-new` ratchet (`docs/ADOPTION.md`)  
- **In flight:** publish `0.1.0` (pack + INSTALL; GitHub Packages scope/owner gate) → limited invite (`docs/INVITE.md`) — plan `docs/superpowers/plans/2026-08-06-phase-next-ratchet-publish.md`  
